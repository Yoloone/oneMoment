...
import { getLikeList, actions as homeActions } from '../../redux/modules/home';
...
class Home extends Component {
    render() {
        const { likes, actions: {loadLikes}} = this.props;
        return (
            <div>
                <LikeList likes={likes} loadLikes={loadLikes}/>
            </div>
        );
    }
}
